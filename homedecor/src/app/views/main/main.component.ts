...
export class MainComponent implements OnInit {
  ...
  reviews= [
    ...
    },
    {
      name: 'Аделина',
      image:'review-4.jpg' ,
      text:'Хочу поблагодарить всю команду за помощь в подборе подарка для моей мамы! Все просто в восторге от мини-сада! А самое главное, что за ним удобно ухаживать. '
    },
    {
      name: 'Аника',
      image:'review-5.jpg' ,
      text:'Спасибо большое за мою обновленную коллекцию суккулентов! Сервис просто на 5+: быстро, удобно, недорого.'
    },
    {
      name: 'Марина',
      image:'review-6.jpg' ,
